...
export default function MobileRow({
  ...
  return (
    ...
    >
                      ...
                      {languageRef && (
                        <div className="">
                          <TextToSpeech text={cardData.term} lang={languageRef}>
                            <SpeakerWaveIcon className="h-7 w-7 text-gray-500 hover:text-blue-500 cursor-pointer" />
                          </TextToSpeech>
                        </div>
                      )}
                    </div>
                    <span className="ml-5 text-lg">
                      {cardData.definition_2}
                    </span>
                  </div>
                </div>
              </>
      ...
      {/* Actions */}
      {isOwner && (
        <div className="absolute top-full right-0 !mt-0 -translate-y-8 -translate-x-[160px]  flex items-center space-x-4 mr-6">
          {!editting && (
            <>
              <button>
                <PencilIcon
