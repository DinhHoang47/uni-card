...
import { closeAPIKeyInput } from "@redux/modalSlice";
...
export default function APIKeyInput({ hanger, user }) {
  // Global state
    ...
    <div className="space-y-4">
      <div className="">
        <h3 className="text-center relative">
          You need an OpenAI API Key to use this function{" "}
